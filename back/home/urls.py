...
urlpatterns = [
    ...
    path('api/get-guest-reservations', views.get_guest_reservations, name='get_user_data'),
    ...
    path('api/create-reservation',views.create_reservation),
    ...
    path('rooms', lambda request: render(request, 'index.html', {'key': 'value'}), name='profile'),
    path('rooms/listing', lambda request: render(request, 'index.html', {'key': 'value'}), name='profile')
]
